// Dafny program WriteBytesToFile.dfy compiled into C#
...
module WriteBytesToFile {
  ...
  method Main(args: seq<string>)
    decreases args
  {
    expect |args| > 0, ""expectation violation""
    expect |args| == 3, ""usage: "" + args[0] + "" OUTPUT_DIR EXPECTED_ERROR_PREFIX""
    var outputDir := args[1];
    var expectedErrorPrefix := args[2];
    {
      ghost var str := ""Hello world\nGoodbye\n"";
      var bytes: seq<bv8> := [72, 101, 108, 108, 111, 32, 119, 111, 114, 108, 100, 10, 71, 111, 111, 100, 98, 121, 101, 10];
      assert forall i: int {:trigger str[i]} {:trigger bytes[i]} | 0 <= i < |bytes| :: bytes[i] as int == str[i] as int;
      {
...
namespace FileIO_Compile {
  ...
  public partial class __default {
    public static Wrappers_Compile._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> ReadBytesFromFile(Dafny.ISequence<char> path)
    {
      ...
      bool _16_isError;
      Dafny.ISequence<byte> _17_bytesRead;
      Dafny.ISequence<char> _18_errorMsg;
      bool _out0;
      ...
      _17_bytesRead = _out1;
      _18_errorMsg = _out2;
      res = ((_16_isError) ? (Wrappers_Compile.Result<Dafny.ISequence<byte>, Dafny.ISequence<char>>.create_Failure(_18_errorMsg)) : (Wrappers_Compile.Result<Dafny.ISequence<byte>, Dafny.ISequence<char>>.create_Success(_17_bytesRead)));
      return res;
      return res;
    }
    public static Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> WriteBytesToFile(Dafny.ISequence<char> path, Dafny.ISequence<byte> bytes)
    {
      ...
      bool _19_isError;
      Dafny.ISequence<char> _20_errorMsg;
      bool _out3;
      Dafny.ISequence<char> _out4;
      DafnyLibraries.FileIO.INTERNAL_WriteBytesToFile(path, bytes, out _out3, out _out4);
      _19_isError = _out3;
      _20_errorMsg = _out4;
      res = ((_19_isError) ? (Wrappers_Compile.Result<_System._ITuple0, Dafny.ISequence<char>>.create_Failure(_20_errorMsg)) : (Wrappers_Compile.Result<_System._ITuple0, Dafny.ISequence<char>>.create_Success(_System.Tuple0.create())));
      return res;
      return res;
    }
  }
} // end of namespace FileIO_Compile
namespace WriteBytesToFile_Compile {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> args)
    {
      if (!((new BigInteger((args).Count)).Sign == 1)) {
        throw new Dafny.HaltException("WriteBytesToFile.dfy(29,4): " + Dafny.Sequence<char>.FromString("expectation violation"));
      }
      if (!((new BigInteger((args).Count)) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("WriteBytesToFile.dfy(30,4): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("usage: "), (args).Select(BigInteger.Zero)), Dafny.Sequence<char>.FromString(" OUTPUT_DIR EXPECTED_ERROR_PREFIX")));
      }
      Dafny.ISequence<char> _21_outputDir;
      _21_outputDir = (args).Select(BigInteger.One);
      Dafny.ISequence<char> _22_expectedErrorPrefix;
      _22_expectedErrorPrefix = (args).Select(new BigInteger(2));
      {
        Dafny.ISequence<byte> _23_bytes;
        _23_bytes = Dafny.Sequence<byte>.FromElements((byte)(72), (byte)(101), (byte)(108), (byte)(108), (byte)(111), (byte)(32), (byte)(119), (byte)(111), (byte)(114), (byte)(108), (byte)(100), (byte)(10), (byte)(71), (byte)(111), (byte)(111), (byte)(100), (byte)(98), (byte)(121), (byte)(101), (byte)(10));
        {
          Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _24_res;
          Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _out5;
          _out5 = FileIO_Compile.__default.WriteBytesToFile(Dafny.Sequence<char>.Concat(_21_outputDir, Dafny.Sequence<char>.FromString("/output_plain")), _23_bytes);
          _24_res = _out5;
          if (!((_24_res).is_Success)) {
            throw new Dafny.HaltException("WriteBytesToFile.dfy(53,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure writing to output_plain: "), (_24_res).dtor_error));
          }
        }
        {
          Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _25_res;
          Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _out6;
          _out6 = FileIO_Compile.__default.WriteBytesToFile(Dafny.Sequence<char>.Concat(_21_outputDir, Dafny.Sequence<char>.FromString("/foo/bar/output_nested")), _23_bytes);
          _25_res = _out6;
          if (!((_25_res).is_Success)) {
            throw new Dafny.HaltException("WriteBytesToFile.dfy(58,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure writing to output_nested: "), (_25_res).dtor_error));
          }
        }
        {
          Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _26_res;
          Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _out7;
          _out7 = FileIO_Compile.__default.WriteBytesToFile(Dafny.Sequence<char>.Concat(_21_outputDir, Dafny.Sequence<char>.FromString("/foo/bar/../output_up")), _23_bytes);
          _26_res = _out7;
          if (!((_26_res).is_Success)) {
            throw new Dafny.HaltException("WriteBytesToFile.dfy(63,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure writing to output_up: "), (_26_res).dtor_error));
          }
        }
      }
      {
        Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _27_res;
        Wrappers_Compile._IResult<_System._ITuple0, Dafny.ISequence<char>> _out8;
        _out8 = FileIO_Compile.__default.WriteBytesToFile(Dafny.Sequence<char>.FromString(""), Dafny.Sequence<byte>.FromElements());
        _27_res = _out8;
        if (!((_27_res).is_Failure)) {
          throw new Dafny.HaltException("WriteBytesToFile.dfy(70,6): " + Dafny.Sequence<char>.FromString("unexpected success"));
        }
        if (!(Dafny.Sequence<char>.IsPrefixOf(_22_expectedErrorPrefix, (_27_res).dtor_error))) {
          throw new Dafny.HaltException("WriteBytesToFile.dfy(71,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_27_res).dtor_error));
        }
      }
    }
  }
} // end of namespace WriteBytesToFile_Compile
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => WriteBytesToFile_Compile.__default._Main(Dafny.Sequence<Dafny.ISequence<char>>.FromMainArguments(args)));
  }
}
