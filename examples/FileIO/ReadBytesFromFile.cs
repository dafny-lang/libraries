// Dafny program ReadBytesFromFile.dfy compiled into C#
...
namespace ReadBytesFromFile_Compile {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> args)
    {
      if (!((new BigInteger((args).Count)).Sign == 1)) {
        throw new Dafny.HaltException("ReadBytesFromFile.dfy(18,4): " + Dafny.Sequence<char>.FromString("expectation violation"));
      }
      if (!((new BigInteger((args).Count)) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("ReadBytesFromFile.dfy(19,4): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("usage: "), (args).Select(BigInteger.Zero)), Dafny.Sequence<char>.FromString(" DATA_PATH EXPECTED_ERROR_PREFIX")));
      }
      Dafny.ISequence<char> _21_dataPath;
      _21_dataPath = (args).Select(BigInteger.One);
      Dafny.ISequence<char> _22_expectedErrorPrefix;
      _22_expectedErrorPrefix = (args).Select(new BigInteger(2));
      {
        Dafny.ISequence<char> _23_expectedStr;
        _23_expectedStr = Dafny.Sequence<char>.FromString("Hello world\nGoodbye\n");
        Dafny.ISequence<BigInteger> _24_expectedBytes;
        _24_expectedBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          BigInteger dim0 = new BigInteger((_23_expectedStr).Count);
          var arr0 = new BigInteger[Dafny.Helpers.ToIntChecked(dim0, "array size exceeds memory limit")];
          for (int i0 = 0; i0 < dim0; i0++) {
            var _25_i = (BigInteger) i0;
            arr0[(int)(_25_i)] = new BigInteger((_23_expectedStr).Select(_25_i));
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr0);
        }))();
        Wrappers_Compile._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _26_res;
        Wrappers_Compile._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out5;
        _out5 = FileIO_Compile.__default.ReadBytesFromFile(_21_dataPath);
        _26_res = _out5;
        if (!((_26_res).is_Success)) {
          throw new Dafny.HaltException("ReadBytesFromFile.dfy(30,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_26_res).dtor_error));
        }
        Dafny.ISequence<BigInteger> _27_readBytes;
        _27_readBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          BigInteger dim1 = new BigInteger(((_26_res).dtor_value).Count);
          var arr1 = new BigInteger[Dafny.Helpers.ToIntChecked(dim1, "array size exceeds memory limit")];
          for (int i1 = 0; i1 < dim1; i1++) {
            var _28_i = (BigInteger) i1;
            arr1[(int)(_28_i)] = new BigInteger(((_26_res).dtor_value).Select(_28_i));
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr1);
        }))();
        if (!((_27_readBytes).Equals((_24_expectedBytes)))) {
          throw new Dafny.HaltException("ReadBytesFromFile.dfy(33,6): " + Dafny.Sequence<char>.FromString("read unexpected byte sequence"));
        }
      }
      {
        Wrappers_Compile._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _29_res;
        Wrappers_Compile._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out6;
        _out6 = FileIO_Compile.__default.ReadBytesFromFile(Dafny.Sequence<char>.FromString(""));
        _29_res = _out6;
        if (!((_29_res).is_Failure)) {
          throw new Dafny.HaltException("ReadBytesFromFile.dfy(39,6): " + Dafny.Sequence<char>.FromString("unexpected success"));
        }
        if (!(Dafny.Sequence<char>.IsPrefixOf(_22_expectedErrorPrefix, (_29_res).dtor_error))) {
          throw new Dafny.HaltException("ReadBytesFromFile.dfy(40,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_29_res).dtor_error));
        }
      }
    }
  }
} // end of namespace ReadBytesFromFile_Compile
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => ReadBytesFromFile_Compile.__default._Main(Dafny.Sequence<Dafny.ISequence<char>>.FromMainArguments(args)));
  }
}
